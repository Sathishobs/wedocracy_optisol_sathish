...
-(IBAction)buttonPressed:(UIButton *)button {
    ...
    switch (button.tag) {
        ...
        case 0: {
            // Make toast
            [self.view makeToast:@"This is a piece of toast." errorType:CSNotificationViewStyleSuccess];
            break;
        }
        ...
        case 1: {
            ...
            [self.view makeToast:@"This is a piece of toast with a title."
                        duration:3.0
                        position:@"top"
                           title:@"Toast Title" errorType:CSNotificationViewStyleError];
        ...
        case 2: {
            ...
            [self.view makeToast:@"This is a piece of toast with an image."
                        duration:3.0
                        position:@"center"
                           image:[UIImage imageNamed:@"toast.png"] errorType:CSNotificationViewStyleSuccess];
            break;
        }
        ...
        case 3: {
            ...
            [self.view makeToast:@"This is a piece of toast with a title & image"
                        ...
                        position:@"bottom"
                           title:@"Toast Title"
                           image:[UIImage imageNamed:@"toast.png"] errorType:CSNotificationViewStyleError];
            break;
        }
        ...
        case 4: {
            ...
            [self.view showToast:customView
                        duration:2.0
                        position:@"center" errorType:CSNotificationViewStyleSuccess];
        ...
        case 5: {
            ...
            [self.view showToast:toastView
                        duration:2.0
                        position:[NSValue valueWithCGPoint:CGPointMake(110, 110)] errorType:CSNotificationViewStyleError]; // wrap CGPoint in an NSValue object
